...
# Class to handle object storage (MinIO, S3, Azure, GCP)
class ObjectStorageClient:
    def __init__(self, storage_type="minio", bucket_name="my-fastapi-bucket-callsign", endpoint_url=None, region_name=None):
        ...
        if storage_type == "minio" or storage_type == "s3":
            ...
            self.bucket = self.gcp_client.get_bucket(bucket_name)
...
# Determine storage type (minio for local, s3 for AWS, azure for Azure Blob, gcp for Google Cloud Storage)
